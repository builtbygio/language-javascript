...
declare function waits(ms: number): void;
declare function runs(fn: () => any): void;
...
describe("JavaScript grammar", function() {
  ...
  describe("strings", function() {
    it("tokenizes single-line strings", function() {
      ...
      return (() => {
        const result = [];
        for (var scope in delimsByScope) {
          var delim = delimsByScope[scope];
          var {tokens} = grammar.tokenizeLine(delim + "x" + delim);
          ...
          result.push(expect(tokens[2].scopes).toEqual(["source.js", scope, "punctuation.definition.string.end.js"]));
        }
        return result;
      })();
  });

    it("tokenizes invalid multiline strings", function() {
      const delimsByScope = {
        "string.quoted.double.js": '"',
        "string.quoted.single.js": "'"
      };
      ...
      return (() => {
        ...
        for (var scope in delimsByScope) {
          var delim = delimsByScope[scope];
          var lines = grammar.tokenizeLines(delim + `\
line1
line2\\
line3\
` + delim
          ...
          result.push(expect(lines[2][1]).toEqual({value: delim, scopes: ['source.js', scope, 'punctuation.definition.string.end.js']}));
        }
        return result;
      })();
  });
    ...
    return describe("Unicode escape sequences", function() {
      ...
      it("tokenises 2-digit sequences", () => (() => {
        const result = [];
        for (var scope in delimsByScope) {
          var quote = delimsByScope[scope];
          var {tokens} = grammar.tokenizeLine(quote + '\\x2011' + quote);
          ...
          result.push(expect(tokens[3]).toEqual({value: quote, scopes: ['source.js', scope, 'punctuation.definition.string.end.js']}));
        }
        return result;
      })());
      ...
      it("tokenises 4-digit sequences", () => (() => {
        ...
        for (var scope in delimsByScope) {
          var quote = delimsByScope[scope];
          var {tokens} = grammar.tokenizeLine(quote + '\\u2011' + quote);
          expect(tokens[0]).toEqual({value: quote, scopes: ['source.js', scope, 'punctuation.definition.string.begin.js']});
          expect(tokens[1]).toEqual({value: '\\u2011', scopes: ['source.js', scope, 'constant.character.escape.js']});
          result.push(expect(tokens[2]).toEqual({value: quote, scopes: ['source.js', scope, 'punctuation.definition.string.end.js']}));
        }
        return result;
      })());
      ...
      it("tokenises variable-length sequences", () => (() => {
        ...
        for (var scope in delimsByScope) {
          var quote = delimsByScope[scope];
          var {tokens} = grammar.tokenizeLine(quote + '\\u{2000}' + quote);
          expect(tokens[0]).toEqual({value: quote, scopes: ['source.js', scope, 'punctuation.definition.string.begin.js']});
          ...
          result.push(expect(tokens[5]).toEqual({value: quote, scopes: ['source.js', scope, 'punctuation.definition.string.end.js']}));
        }
        return result;
      })());
      ...
      it("highlights sequences with invalid syntax", () => (() => {
        const result = [];
        for (var invalid of ['\\u', '\\u{2000', '\\u{G}']) {
          var {tokens} = grammar.tokenizeLine('"' + invalid + '"');
          result.push(expect(tokens[1]).toEqual({value: invalid, scopes: ['source.js', 'string.quoted.double.js', 'invalid.illegal.unicode-escape.js']}));
        }
        return result;
      })());
      ...
      return it("highlights sequences with invalid codepoints", function() {
        ...
        return (() => {
          const result = [];
          for (var codepoint of [0x5000, 0x11FFFF, 0x1000000, maxCodepoint]) {
            var pointStr = codepoint.toString(16).toUpperCase().replace(/^0x/, "");
            var {tokens} = grammar.tokenizeLine('"\\u{' + pointStr + '}"');
            var pointScopes = ['source.js', 'string.quoted.double.js', 'constant.character.escape.js'];
            if (codepoint > maxCodepoint) { pointScopes.push('invalid.illegal.unicode-escape.js'); }
            ...
            result.push(expect(tokens[5]).toEqual({value: '"', scopes: ['source.js', 'string.quoted.double.js', 'punctuation.definition.string.end.js']}));
          }
          return result;
        })();
    });
  ...
  describe("keywords", function() {
    const keywords = ['await', 'break', 'catch', 'continue', 'do'];
  ...
  describe("built-in globals", function() {
    it("tokenizes built-in classes", function() {
      let {tokens} = grammar.tokenizeLine('window');
  ...
  describe("instantiation", () => it("tokenizes the new keyword and instance entities", function() {
    let {tokens} = grammar.tokenizeLine('new something');
  ...
  describe("regular expressions", function() {
    ...
    it("tokenizes regular expressions inside arrow function expressions", function() {
      const {tokens} = grammar.tokenizeLine('getRegex = () => /^helloworld$/;');
  ...
  describe("operators", function() {
    it("tokenizes them", function() {
      const operators = ["delete", "in", "of", "instanceof", "new", "typeof", "void"];

      return (() => {
        const result = [];
        for (var operator of Array.from(operators)) {
          var {tokens} = grammar.tokenizeLine(operator);
          result.push(expect(tokens[0]).toEqual({value: operator, scopes: ['source.js', 'keyword.operator.' + operator  + '.js']}));
        }
        return result;
      })();
  });

    it("tokenizes spread operator", function() {
      let {tokens} = grammar.tokenizeLine('myFunction(...args);');
    ...
    describe("logical", function() {
      ...
      return it("tokenizes them", () => (() => {
        const result = [];
        for (var operator of Array.from(operators)) {
          var {tokens} = grammar.tokenizeLine('a ' + operator + ' b');
          ...
          result.push(expect(tokens[2]).toEqual({value: ' b', scopes: ['source.js']}));
        }
        return result;
      })());
  });
    ...
    describe("arithmetic", function() {
      ...
      return it("tokenizes the arithmetic operators when separated by newlines", () => (() => {
        const result = [];
        for (var operator of Array.from(operators)) {
          var lines = grammar.tokenizeLines('1\n' + operator + ' 2');
          ...
          result.push(expect(lines[1][2]).toEqual({value: '2', scopes: ['source.js', 'constant.numeric.decimal.js']}));
        }
        return result;
      })());
  });
    ...
    return describe("assignment", function() {
      ...
      return describe("compound", function() {
        ...
        return describe("bitwise", () => it("tokenizes them", function() {
          const operators = ["<<=", ">>=", ">>>=", "&=", "^=", "|="];
          return (() => {
            const result = [];
            for (var operator of Array.from(operators)) {
  ...
  describe("constants", function() {
    it("tokenizes ALL_CAPS variables as constants", function() {
      let {tokens} = grammar.tokenizeLine('var MY_COOL_VAR = 42;');
      expect(tokens[0]).toEqual({value: 'var', scopes: ['source.js', 'storage.type.var.js']});
    ...
    it("tokenises constants with dollar signs", function() {
      const constants = ['CON$TANT', 'ABC$', 'ABC$D', '$_ALL', 'ALL_$', 'ANGULAR$$$$$$$$$$$'];
      return (() => {
        const result = [];
        for (var constant of Array.from(constants)) {
          var {tokens} = grammar.tokenizeLine(constant);
          result.push(expect(tokens[0]).toEqual({value: constant, scopes: ['source.js', 'constant.other.js']}));
        }
        return result;
      })();
  });
    ...
    it("doesn't tokenise constants without alphabetic characters", () => (() => {
      const result = [];
      for (var name of ['$_', '$', '_', '$_$_$_$___$___$____$']) {
        var {tokens} = grammar.tokenizeLine(name);
        result.push(expect(tokens[0]).toEqual({value: name, scopes: ['source.js']}));
      }
      return result;
    })());

    it("tokenizes variables declared using `const` as constants", function() {
      let {tokens} = grammar.tokenizeLine('const myCoolVar = 42;');
...
`
    ...
    it("tokenizes variables declared with `const` in for-in and for-of loops", function() {
      let {tokens} = grammar.tokenizeLine('for (const elem of array) {');
    ...
    it("tokenizes support constants", function() {
      const {tokens} = grammar.tokenizeLine('awesome = cool.EPSILON;');
  ...
  describe("ES6 string templates", () => it("tokenizes them as strings", function() {
    let {tokens} = grammar.tokenizeLine('`hey ${name}`');
  ...
  describe("HTML template strings", function() {
    ...
    let [tagScope, entityScope] = Array.from([]);
    ...
    it("tokenizes innerHTML attribute declarations with string template tags", function() {
      const {tokens} = grammar.tokenizeLine('text.innerHTML = `hey <b>${name}</b>`');
  ...
  describe("ES6 tagged Relay.QL string templates", () => it("tokenizes them as strings", function() {
    const {tokens} = grammar.tokenizeLine('Relay.QL`fragment on Foo { id }`');
  ...
  describe("ES6 tagged Relay.QL string templates with interpolation", () => it("tokenizes them as strings", function() {
    const {tokens} = grammar.tokenizeLine('Relay.QL`fragment on Foo { ${myFragment} }`');
    expect(tokens[0]).toEqual({value: 'Relay.QL', scopes: ['source.js', 'string.quoted.template.graphql.js', 'entity.name.function.js']});
    expect(tokens[1]).toEqual({value: '`', scopes: ['source.js', 'string.quoted.template.graphql.js', 'punctuation.definition.string.begin.js']});
    ...
    return expect(tokens[7]).toEqual({value: '`', scopes: ['source.js', 'string.quoted.template.graphql.js', 'punctuation.definition.string.end.js']});
}));

  describe("ES6 tagged gql string templates", () => it("tokenizes them as strings", function() {
    const {tokens} = grammar.tokenizeLine('gql`fragment on Foo { id }`');
  ...
  describe("ES6 tagged SQL string templates", () => it("tokenizes them as strings", function() {
    const {tokens} = grammar.tokenizeLine('SQL`SELECT foo FROM bar WHERE id = :id`');
  ...
  describe("ES6 class", function() {
    it("tokenizes class", function() {
      let {tokens} = grammar.tokenizeLine('class MyClass');
    ...
    it("tokenizes class...extends", function() {
      let {tokens} = grammar.tokenizeLine('class MyClass extends SomeClass');
      expect(tokens[0]).toEqual({value: 'class', scopes: ['source.js', 'meta.class.js', 'storage.type.class.js']});
      expect(tokens[2]).toEqual({value: 'MyClass', scopes: ['source.js', 'meta.class.js', 'entity.name.type.class.js']});
  ...
  describe("ES6 import", function() {
    it("tokenizes import", function() {
      const {tokens} = grammar.tokenizeLine('import "module-name";');
    ...
    it("tokenizes default named import", function() {
      const {tokens} = grammar.tokenizeLine('import { default as defaultMember } from "module-name";');
      expect(tokens[0]).toEqual({value: 'import', scopes: ['source.js', 'meta.import.js', 'keyword.control.js']});
    ...
    it("tokenizes named import", function() {
      let {tokens} = grammar.tokenizeLine('import { member } from "module-name";');
      expect(tokens[0]).toEqual({value: 'import', scopes: ['source.js', 'meta.import.js', 'keyword.control.js']});
      expect(tokens[2]).toEqual({value: '{', scopes: ['source.js', 'meta.import.js', 'punctuation.definition.modules.begin.js']});
    ...
    it("tokenizes entire module import", function() {
      const {tokens} = grammar.tokenizeLine('import * as name from "module-name";');
      expect(tokens[0]).toEqual({value: 'import', scopes: ['source.js', 'meta.import.js', 'keyword.control.js']});
    ...
    it("tokenizes `import defaultMember, { member } from 'module-name';`", function() {
      const {tokens} = grammar.tokenizeLine('import defaultMember, { member } from "module-name";');
      expect(tokens[0]).toEqual({value: 'import', scopes: ['source.js', 'meta.import.js', 'keyword.control.js']});
      expect(tokens[2]).toEqual({value: 'defaultMember', scopes: ['source.js', 'meta.import.js', 'variable.other.module.js']});
    ...
    it("tokenizes `import defaultMember, * as alias from 'module-name';", function() {
      const {tokens} = grammar.tokenizeLine('import defaultMember, * as alias from "module-name";');
      expect(tokens[0]).toEqual({value: 'import', scopes: ['source.js', 'meta.import.js', 'keyword.control.js']});
      expect(tokens[2]).toEqual({value: 'defaultMember', scopes: ['source.js', 'meta.import.js', 'variable.other.module.js']});
      expect(tokens[3]).toEqual({value: ',', scopes: ['source.js', 'meta.import.js', 'meta.delimiter.object.comma.js']});
...
`
  ...
  describe("ES6 export", function() {
    it("tokenizes named export", function() {
      let {tokens} = grammar.tokenizeLine('export var x = 0;');
    ...
    it("tokenizes existing variable export", function() {
      let {tokens} = grammar.tokenizeLine('export { bar };');
      expect(tokens[0]).toEqual({value: 'export', scopes: ['source.js', 'meta.export.js', 'keyword.control.js']});
    ...
    it("tokenizes default export", function() {
      let {tokens} = grammar.tokenizeLine('export default 123;');
      expect(tokens[0]).toEqual({value: 'export', scopes: ['source.js', 'meta.export.js', 'keyword.control.js']});
...
`));
    ...
    it("tokenizes default function export", function() {
      let {tokens} = grammar.tokenizeLine('export default function () {}');
      expect(tokens[0]).toEqual({value: 'export', scopes: ['source.js', 'meta.export.js', 'keyword.control.js']});
      expect(tokens[2]).toEqual({value: 'default', scopes: ['source.js', 'meta.export.js', 'variable.language.default.js']});
...
`
      ...
      const {tokens} = grammar.tokenizeLine('export {member1, /* comment */ member2} /* comment */ from "module";');
    ...
    it("tokenizes default class export", function() {
      let {tokens} = grammar.tokenizeLine('export default class {}');
      expect(tokens[0]).toEqual({value: 'export', scopes: ['source.js', 'meta.export.js', 'keyword.control.js']});
      expect(tokens[2]).toEqual({value: 'default', scopes: ['source.js', 'meta.export.js', 'variable.language.default.js']});
    ...
    it("tokenizes re-export", function() {
      let {tokens} = grammar.tokenizeLine('export { name } from "module-name";');
      expect(tokens[0]).toEqual({value: 'export', scopes: ['source.js', 'meta.export.js', 'keyword.control.js']});
      expect(tokens[2]).toEqual({value: '{', scopes: ['source.js', 'meta.export.js', 'punctuation.definition.modules.begin.js']});
      expect(tokens[4]).toEqual({value: 'name', scopes: ['source.js', 'meta.export.js', 'variable.other.module.js']});
      expect(tokens[6]).toEqual({value: '}', scopes: ['source.js', 'meta.export.js', 'punctuation.definition.modules.end.js']});
...
`
  ...
  describe("functions", function() {
    it("tokenizes regular function declarations", function() {
      let {tokens} = grammar.tokenizeLine('function foo(){}');
...
`
    ...
    it("tokenizes anonymous functions", function() {
      const {tokens} = grammar.tokenizeLine('function (){}');
      expect(tokens[0]).toEqual({value: 'function', scopes: ['source.js', 'meta.function.js', 'storage.type.function.js']});
    ...
    it("tokenizes functions as object properties", function() {
      let {tokens} = grammar.tokenizeLine('obj.method = function foo(');
    ...
    it("tokenises getter/setter keywords", function() {
      const {tokens} = grammar.tokenizeLine('get name(){ }');
    ...
    it("tokenizes ES6 method definitions", function() {
      let {tokens} = grammar.tokenizeLine('f(a, b) {}');
    ...
    it("tokenizes constructors", function() {
      let {tokens} = grammar.tokenizeLine('constructor(p1, p2) { this.p1 = p1; }');
    ...
    it("tokenizes named function expressions", function() {
      const {tokens} = grammar.tokenizeLine('var func = function foo(){}');
      expect(tokens[0]).toEqual({value: 'var', scopes: ['source.js', 'storage.type.var.js']});
    ...
    it("tokenizes anonymous function expressions", function() {
      const {tokens} = grammar.tokenizeLine('var func = function(){}');
      expect(tokens[0]).toEqual({value: 'var', scopes: ['source.js', 'storage.type.var.js']});
      expect(tokens[2]).toEqual({value: 'func', scopes: ['source.js', 'meta.function.js', 'entity.name.function.js']});
      expect(tokens[4]).toEqual({value: '=', scopes: ['source.js', 'meta.function.js', 'keyword.operator.assignment.js']});
      expect(tokens[6]).toEqual({value: 'function', scopes: ['source.js', 'meta.function.js', 'storage.type.function.js']});
    ...
    it("tokenizes functions in object literals", function() {
      let {tokens} = grammar.tokenizeLine('func: function foo(');
    ...
    it("tokenizes arrow functions", function() {
      let {tokens} = grammar.tokenizeLine('x => x * x');
...
`
    ...
    it("tokenizes stored arrow functions", function() {
      const {tokens} = grammar.tokenizeLine('var func = (p1, p2) => {}');
      expect(tokens[0]).toEqual({value: 'var', scopes: ['source.js', 'storage.type.var.js']});
    ...
    it("tokenizes arrow functions as object properties", function() {
      const {tokens} = grammar.tokenizeLine('Utils.isEmpty = (p1, p2) => {}');
    ...
    it("tokenizes arrow functions in object literals", function() {
      let {tokens} = grammar.tokenizeLine('foo: param => {}');
    ...
    it("tokenizes default parameters", function() {
      let {tokens} = grammar.tokenizeLine('function multiply(a, b = 1){}');
    ...
    it("tokenizes the rest parameter", function() {
      const {tokens} = grammar.tokenizeLine('(...args) => args[0]');
      expect(tokens[1]).toEqual({value: '...', scopes: ['source.js', 'meta.function.arrow.js', 'meta.parameters.js', 'keyword.operator.spread.js']});
      return expect(tokens[2]).toEqual({value: 'args', scopes: ['source.js', 'meta.function.arrow.js', 'meta.parameters.js', 'variable.parameter.rest.function.js']});
  });
...
`
    ...
    return describe("built-in methods", function() {
      ...
      for (var method of Array.from(methods)) {
        it(`tokenizes '${method}'`, function() {
          const {tokens} = grammar.tokenizeLine('.' + method + '()');
      ...
      return Array.from(domMethods).map((domMethod) =>
        it(`tokenizes '${domMethod}'`, function() {
          const {tokens} = grammar.tokenizeLine('.' + domMethod + '()');
          expect(tokens[0]).toEqual({value: '.', scopes: ['source.js', 'meta.method-call.js', 'meta.delimiter.method.period.js']});
  ...
  describe("properties", function() {
    ...
    return it("tokenizes constant properties", function() {
  ...
  describe("strings and functions", () => it("doesn't confuse them", function() {
    ...
    return (() => {
      ...
      for (var scope in delimsByScope) {
        ...
        result.push(expect(tokens[15]).toEqual({value: ')', scopes: ['source.js', 'meta.method-call.js', 'meta.arguments.js', 'punctuation.definition.arguments.end.bracket.round.js']}));
      }
      return result;
    })();
}));
  ...
  describe("comments", function() {
    ...
    it("tokenizes // comments", function() {
      ...
      expect(tokens[0]).toEqual({value: '//', scopes: ['source.js', 'comment.line.double-slash.js', 'punctuation.definition.comment.js']});
      return expect(tokens[1]).toEqual({value: ' comment', scopes: ['source.js', 'comment.line.double-slash.js']});
  });

    it("tokenizes comments inside constant definitions", function() {
      const {tokens} = grammar.tokenizeLine('const a, // comment');
      expect(tokens[0]).toEqual({value: 'const', scopes: ['source.js', 'storage.type.const.js']});
...
`
  ...
  describe("console", function() {
    it("tokenizes the console keyword", function() {
      let {tokens} = grammar.tokenizeLine('console;');
    ...
    it("tokenizes console support functions", function() {
      let {tokens} = grammar.tokenizeLine('console.log().log()');
      expect(tokens[0]).toEqual({value: 'console', scopes: ['source.js', 'entity.name.type.object.console.js']});
      expect(tokens[1]).toEqual({value: '.', scopes: ['source.js', 'meta.method-call.js', 'meta.delimiter.method.period.js']});
...
`
  ...
  describe("math", function() {
    ...
    it("tokenizes math support functions/properties", function() {
      let {tokens} = grammar.tokenizeLine('Math.random();');
      expect(tokens[0]).toEqual({value: 'Math', scopes: ['source.js', 'support.class.math.js']});
      expect(tokens[1]).toEqual({value: '.', scopes: ['source.js', 'meta.method-call.js', 'meta.delimiter.method.period.js']});
...
`
  ...
  describe("promise", function() {
    ...
    it("tokenizes promise support functions", function() {
      const {tokens} = grammar.tokenizeLine('Promise.race();');
      expect(tokens[0]).toEqual({value: 'Promise', scopes: ['source.js', 'support.class.promise.js']});
      expect(tokens[1]).toEqual({value: '.', scopes: ['source.js', 'meta.method-call.js', 'meta.delimiter.method.period.js']});
...
`
  ...
  describe("object literals", function() {
    const keywords = ['super', 'this', 'null', 'true', 'false', 'debugger', 'exports', '__filename'];
    ...
    it("tokenizes object keys", function() {
  ...
  describe("switch statements", function() {
    ...
    it("tokenizes switch expression", function() {
      const {tokens} = grammar.tokenizeLine('switch(foo + bar){}');
